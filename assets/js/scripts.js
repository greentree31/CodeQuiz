...
var qcodeEl = document.getElementById('qcode-screen');
...
function  startQuiz() {
    ...
    timerId = setInterval(timeMove, 500);
...
function getQcode() {
    ...
    titleEl.textContent = currentQcode.title;

    choicesEl.innerHTML = '';

    currentQcode.choices.forEach(function(choice, i) {
